...
import com.mofakin.releqt.common.block.BlockFirepit;
...
public class RelEqtFirepitEffect extends CampfireBlockEffect{
	
    @Override
    public double getTemperature(PlayerEntity player, BlockState state, BlockPos pos, double distance)
    {
        if (this.hasBlock(state) && state.getValue(BlockFirepit.LIT))
        {
    ...
    {
    	return block.getBlock() instanceof BlockFirepit;
    }
}
...
import com.mofakin.releqt.common.block.BlockStove;
...
public class RelEqtStoveEffect extends CampfireBlockEffect{
	
    @Override
    public double getTemperature(PlayerEntity player, BlockState state, BlockPos pos, double distance)
    {
        if (this.hasBlock(state) && state.getValue(BlockStove.LIT))
        {
    ...
    {
    	return block.getBlock() instanceof BlockStove;
    }
}